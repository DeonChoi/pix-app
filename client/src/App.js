		...
		<Router basename={"/"}>
			<header>
				<nav className="navbar navbar-expand-lg navbar-light bg-light">
					...
					<form
						className="form-inline mt-3 mb-3 search-form has-search justify-content-center"
						onSubmit={getSearch}>
						<input
						...
						/>
						<button
							className="btn btn-outline-primary my-2 my-sm-0 search-button"
							type="submit">
					...
					{localStorage.getItem("auth-token") !== null ? (
						<div
							...
							<Link to={"/collections"} className="nav-link text-primary">
								collections <span className="sr-only">(current)</span>
							</Link>
