			...
			{localStorage.getItem("auth-token") === null ? (
				<div
					...
					<p className="lead text-center">
						You must register and login to view your collections.
					</p>
				...
				<>
					...
					{deleteImageShow ? <div id="modal">Image Deleted</div> : ""}
								...
								<div className="image-card" key={image.photoID}>
									...
									<div className="card-img-overlay">
										...
										<button
											...
											onClick={() =>
												download(image.urlsRaw, image.altDescription + ".png")
											}>
									...
									<div
										...
										<span className="modal-buttons">
											<button
												...
												style={{ color: "red" }}
												onClick={() =>
													closeImageViewModal(`dc${image.photoID}`)
												}>
												<i className="fas fa-times"></i>
											</button>
											<button
